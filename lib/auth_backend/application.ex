defmodule AuthBackend.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      AuthBackendWeb.Endpoint,
      AuthBackend.LoggedPlayers
    ]

    # See https://hexdocs.pm/elixir/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: AuthBackend.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    AuthBackendWeb.Endpoint.config_change(changed, removed)
    :ok
  end
